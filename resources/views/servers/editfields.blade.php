...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('Service_Contract', ['0' => 'Select Option', 'Yes' => 'Yes', 'No' => 'No'], null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('ISD_Allowed', ['0' => 'Select Option', 'Yes' => 'Yes', 'No' => 'No'], null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('Queue_stats', ['0' => 'Select Option', 'Yes' => 'Yes', 'No' => 'No'], null, ['class' => 'form-control']) !!}
</div>

<!-- Customer Report Field -->
<div class="form-group col-sm-6">
    {!! Form::label('Customer_Report', 'Custom Report:') !!}
    {!! Form::select('Customer_Report',['0' => 'Select Option', 'Yes' => 'Yes', 'No' => 'No'], null, ['class' => 'form-control']) !!}
</div>

<!-- Q Panel Field -->
<div class="form-group col-sm-6">
    {!! Form::label('Q_Panel', 'Q Panel:') !!}
    {!! Form::select('Q_Panel', ['0' => 'Select Option', 'Yes' => 'Yes', 'No' => 'No'], null , ['class' => 'form-control']) !!}
</div>
